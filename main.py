...
dispatchers = {
    "🚛 Диспетчер Andrew": ["Водитель RAMIL KHAFIZOV", "Водитель OLEG RESHAEV", "Водитель RUSTAM TAMBIEV"],
    ...
    "🚂 Диспетчер Peter": ["Водитель TSYDEN TOBODORZHIEV", "Водитель DENIS COLESNICENCO", "Водитель VIKTOR ATANOV", "Водитель AZAT AZAMAT", "Водитель DIONISIE COTOVICI", "Водитель AZAT BORONCHIEV"],
    ...
    "✈ Диспетчер Max": [],
    "🎈 Диспетчер NONE": ["Водитель (Said) MAGOMEDSAID GABIBULAEV", "Водитель MIRBEK ALOEV", "Водитель SOSLAN GAGLOEV", "Водитель GREENGREYLINE KALCHUK GRYGORII", "Водитель VITALII HONCHAROV", "Водитель GRIGORII MOSKALETS", "Водитель RUSTAM TAMBIEV", "Водитель YEVHENII MATVIEIEV", "Водитель SRV URUZMAG TSAKOEV", "Водитель MIM Logistics INC VALENTIN NEIZHKO", "Водитель SRV Trust Way INC GEORGII DZOTOV"]
}
